<template>
    <div class="bj">
        ...
        <ul class="bjBottom">
            <li>
                <img src="https://img08.jiuxian.com/2018/0806/25bda3b84e1a4ba58b3c31cade52f0662.jpg" alt="">
                <div class="bjBottomDiv">
                    <div class="bjBottomDivTop">
                        <span class="bjBottomDivTopName">45°西凤金窖500ml(2012-2013年）</span><br/>
                        <span class="bjBottomDivTopIcon">限时抢购</span>
                        <span class="bjBottomDivTopCon">N元场</span>
                    </div>
                    <div class="bjBottomDivMiddle">￥59.00</div>
...
export default {
    ...
    created(){
        axios.get("https://m.jiuxian.com/m_v1/home/putaojiu_new/661/150054")
        .then((data)=>{
